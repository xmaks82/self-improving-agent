"""SambaNova API client - free tier with ultra-fast inference."""
...
class SambanovaClient(BaseLLMClient):
    """
    Client for SambaNova Cloud API - OpenAI-compatible interface.

    Free tier: Unlimited (fair use), no credit card required.
    Speed: 580 tokens/sec on 70B, 200 t/s on 405B (fastest for large models).
    ...
    MODELS = {
        ...
        # Llama 3.3 - production (580 t/s!)
        "llama-3.3-70b": "Meta-Llama-3.3-70B-Instruct",
        "samba-llama-70b": "Meta-Llama-3.3-70B-Instruct",

        # Llama 3.1
        "llama-3.1-8b": "Meta-Llama-3.1-8B-Instruct",
        "samba-llama-8b": "Meta-Llama-3.1-8B-Instruct",

        # DeepSeek
        "deepseek-r1-70b": "DeepSeek-R1-Distill-Llama-70B",
        "deepseek-v3": "DeepSeek-V3-0324",
        "samba-deepseek": "DeepSeek-V3-0324",
    ...
    def __init__(self, api_key: Optional[str] = None, model: str = "llama-3.3-70b"):
        ...
        if not api_key:
            raise ValueError(
                "SambaNova API key required. Set SAMBANOVA_API_KEY environment variable.\n"
                "Get free key at: https://cloud.sambanova.ai/"
            )
    ...
    async def stream(
        ...
        """Streaming chat completion - ultra-fast on SambaNova."""
        formatted_messages = []
    ...
    def chat_with_tools(
        ...
        """Chat with tools via SambaNova API."""
        formatted_messages = []
    ...
    def list_models(cls) -> list[str]:
        ...
        return [
            "llama-4-scout",      # Llama 4 preview
            "llama-3.3-70b",      # Production, 580 t/s
            "llama-3.1-8b",       # Fast, small
            "deepseek-r1-70b",    # DeepSeek reasoning
            "deepseek-v3",        # DeepSeek latest
            "qwen3-32b",          # Qwen 3
            "qwq-32b",            # QwQ reasoning
        ]
