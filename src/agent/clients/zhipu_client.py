...
class ZhipuClient(BaseLLMClient):
    ...
    # Available GLM models (updated 2026-04-01)
    MODELS = {
        # Free
        "glm-4.5-flash": "glm-4.5-flash",
        "glm-4.7-flash": "glm-4.7-flash",

        # Paid - GLM-5 series (frontier)
        "glm-5.1": "glm-5.1",           # $1.00/$3.20 per 1M tokens (coding-focused)
        "glm-5": "glm-5",               # $1.00/$3.20 per 1M tokens
        "glm-5-code": "glm-5-code",     # $1.20/$5.00 per 1M tokens
    ...
    def list_models(cls) -> list[str]:
        ...
        return [
            "glm-4.5-flash",   # Free
            "glm-4.7-flash",   # Free
            "glm-5.1",         # Frontier, coding-focused ($1.00/$3.20)
            "glm-5",           # Frontier ($1.00/$3.20)
            "glm-5-code",      # Code specialist ($1.20/$5.00)
            "glm-4.7",         # Balanced ($0.60/$2.20)
            "glm-4.5-air",     # Budget ($0.20/$1.10)
        ]
