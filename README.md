...
| Model | ID | Notes |
|-------|-----|-------|
| Claude Opus 4.6 | `claude-opus-4.6` | Flagship, 200K ctx, 128K output |
| Claude Sonnet 4.5 | `claude-sonnet` | Balance of speed and intelligence |
| Claude Haiku 4.5 | `claude-haiku` | Fast and cheap |
